...
import com.springapp.school_app.model.Holiday;
...
//    @GetMapping("/holidays")
//    public String displayHolidays(@RequestParam(required = false) boolean festival,@RequestParam(required=false) boolean federal,
//                                  Model model) {
